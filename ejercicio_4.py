...
if texto_1 > texto_2:
    ...
    mayor = texto_2
print("El número mayor alfabéticamente es el", mayor,"porque SIETE comienza con 'S', y",texto_1,"comienza con 'C'.")
...
print("El número mayor '>' es el", numero_mayor,"porque(7 > 5)")
